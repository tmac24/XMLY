...
class FMCVLayerView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        // 脉冲效果的颜色  (注释*1)  red: 213/255, green: 54/255, blue: 13/255, alpha: 1
        pulseLayer.fillColor = UIColor(red: 213/255, green: 54/255, blue: 13/255, alpha: 1).cgColor
